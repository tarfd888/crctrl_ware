        ...
        <div class="col-md-4 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    ...
                    <h3 class="card-subtitle text-center  pt-2"><span class="text-bold-600" style="color:#9F8FC9;">SIAM SANITARY WARE INDUSTRY CO., LTD.</span></h3>
					
					<div class="d-flex justify-content-center pt-2">
						<h4 class="text-bold-600" style="color:#9F8FC9;">Creditcontrol</h4>
					</div>									
                </div>
