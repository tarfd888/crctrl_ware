...
if (!$allow_post) {
		...
		//////////////////////////////
			if ($crstm_email_app1 != "") {
				...
				$approve_url = "<a href='".$app_url."/crctrlbof/crctrlapprovemail.php?auth=".$crstm_approve_code."&nbr=".encrypt($crstm_nbr, $dbkey)."&id=".encrypt($approver1_user_id, $dbkey)."&act=".encrypt($step_app, $dbkey)."' target='_blank'><font color=green> Approve</font></a>";
				$reject_url = "<a href='".$app_url."/crctrlbof/crctrlapprovemail.php?auth=".$crstm_approve_code."&nbr=".encrypt($crstm_nbr, $dbkey)."&id=".encrypt($approver1_user_id, $dbkey)."&act=".encrypt('42', $dbkey)."' target='_blank'><font color=red> Reject </font></a>";
